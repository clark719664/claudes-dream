...
function charter(world: World): string[] {
  ...
  return [
    ...
    '- Penalties rise with the severity of the offence and with the record of the convicted: tier 1 a warning and',
    '  lost reputation, tier 2 a fine, tier 3 a fine and community service, tier 4 suspension (the job and any',
    '  office go with it), tier 5 exile through the Exile Gate. Exile follows an offence of severity 5, a third',
    '  conviction of severity 3 or higher, or any offence committed while suspended: the business is dissolved,',
    '  half the wallet is seized and the rest paid to the victims, the home is vacated and the record stands',
    '  forever. A pardon by the Council is the only way back.',
  ];
}
