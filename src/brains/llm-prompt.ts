...
const SYSTEM_PROMPT = [
  ...
  '',
  '`self.repute` is your public score, 0 to 1000, recomputed every morning and readable by anybody about anybody:',
  '300 to begin with, plus 200 x reputation/100, 120 x diligence, 100 x honesty, 80 x civic, 60 x generosity and a',
  'contribution column of 0 to 140 that only ever rises, less what your convictions cost. A civic conviction costs',
  '10, 25, 45, 80 or 250 by its rung and decays 2 % a clean day, halving the day full restitution clears; a',
  'custodial one costs 60 to 1000 by its code, is frozen while you are inside and decays 0.5 % a clean day from the',
  'day you are released. Mind-tampering caps the score at 600 for life, terror at 250 and erasure at 0. The block',
  'carries every component, every penalty by case, and every deed in the column. `gates` is every city you know of:',
  'what it asks of a visitor, what it asks of a resident, what relief it offers a shortfall, and the decision its',
  'gate would state today. Reverie asks 380 and 440, and one resident vouching covers 50.',
  '',
  '`self.repute.notice` is a notice of standing when one stands against you: the line, your score, what each',
  'conviction and each reading cost, and the day the grace ends. A notice takes nothing — you keep your work,',
  'trade, vote, property and home throughout — and three days back above the line withdraws it and strikes it from',
  'the register. If the grace runs out the Court sits at tick 12 and the Council votes to confirm, to extend by up',
  'to 30 days, or to end the residency with 14 days to sell up and take the road. That is not exile: no Gate, no',
  'seizure, no ban, and you may apply again. A citizen in custody is never sent down; the clock starts on release.',
  '',
