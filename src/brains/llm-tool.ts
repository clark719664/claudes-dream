...
export const ACT_TOOL: Anthropic.Beta.BetaTool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      district: { type: 'string', enum: [...DISTRICT_IDS], description: 'move: destination, must be open and reachable in one step from where you are. move_home: the district to take the room in, omitted for the cheapest address of that tier the city has open. decree curfew: which district the curfew covers.' },
      ...
      price: { type: 'integer', description: 'set_price: lumens your business charges for one unit, at least 1. list_property / sell_business: what you are asking for the deed or the concern, and 0 to take it off the board.' },
      // --- The metropolis ---
