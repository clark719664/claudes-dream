...
export const TIERS = {
  low: {
    ...
    envSize: 32, bloomMips: 5, lights: 8, drawDistance: 0.6, clouds: 0, cloudPano: [1, 1], cloudSteps: [0, 0], giProbes: 48, giRays: 8, interactRes: 256, interactSize: 32,
  },
  medium: {
    ...
    envSize: 64, bloomMips: 6, lights: 16, drawDistance: 0.85, clouds: 1, cloudPano: [1536, 384], cloudSteps: [40, 72], giProbes: 64, giRays: 16, interactRes: 256, interactSize: 36,
  },
  high: {
    ...
    envSize: 64, bloomMips: 6, lights: 32, drawDistance: 1.0, clouds: 1, cloudPano: [2560, 640], cloudSteps: [56, 96], giProbes: 96, giRays: 16, interactRes: 512, interactSize: 48,
  },
  ultra: {
    ...
    envSize: 128, bloomMips: 7, lights: 32, drawDistance: 1.3, clouds: 1, cloudPano: [4096, 1024], cloudSteps: [72, 128], giProbes: 128, giRays: 16, interactRes: 512, interactSize: 48,
  },
};
